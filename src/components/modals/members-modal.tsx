...
import { UserAvar } from "@/components/user-avatar"
...
export const MembersModal = () => {
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={onClose} >
      <DialogContent className="bg-white dark:bg-zinc-700/30 text-black dark:text-zinc-100 overflow-hidden">
        ...
        <ScrollArea className="mt-6 max-h-[420px] pr-6">
          {server?.members?.map((member) => (
            <div key={member.id} className="flex items-center gap-x-2 mb-6">
              <UserAvar src={member.profile.imageUrl} />

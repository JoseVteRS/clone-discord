...
export const InviteModal = () => {
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={onClose} >
      <DialogContent className="bg-white dark:bg-zinc-700/30 text-black dark:text-zinc-100 p-0 overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center mt-2 gap-x-2">
            <Input
              ...
              disabled={isLoading}
            />
            <Button size="icon" onClick={onCopy} disabled={copied || isLoading} >
              {
